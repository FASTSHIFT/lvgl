...
enum _lv_style_id_t {
    ...
    LV_STYLE_TRANSFORM_BLUR_RADIUS  = 117,
    LV_STYLE_BITMAP_MASK_SRC        = 118,
    LV_STYLE_ROTARY_SENSITIVITY     = 119,
    LV_STYLE_TRANSLATE_RADIAL       = 120,
    LV_STYLE_RECOLOR                = 121,
    LV_STYLE_RECOLOR_OPA            = 122,

    LV_STYLE_FLEX_FLOW              = 123,
    LV_STYLE_FLEX_MAIN_PLACE        = 124,
    LV_STYLE_FLEX_CROSS_PLACE       = 125,
    LV_STYLE_FLEX_TRACK_PLACE       = 126,
    LV_STYLE_FLEX_GROW              = 127,

    LV_STYLE_GRID_COLUMN_ALIGN      = 128,
    LV_STYLE_GRID_ROW_ALIGN         = 129,
    LV_STYLE_GRID_ROW_DSC_ARRAY     = 130,
    LV_STYLE_GRID_COLUMN_DSC_ARRAY  = 131,
    LV_STYLE_GRID_CELL_COLUMN_POS   = 132,
    LV_STYLE_GRID_CELL_COLUMN_SPAN  = 133,
    LV_STYLE_GRID_CELL_X_ALIGN      = 134,
    LV_STYLE_GRID_CELL_ROW_POS      = 135,
    LV_STYLE_GRID_CELL_ROW_SPAN     = 136,
    LV_STYLE_GRID_CELL_Y_ALIGN      = 137,
    LV_STYLE_IMAGE_COLORKEY         = 138,

    LV_STYLE_LAST_BUILT_IN_PROP     = 139,
